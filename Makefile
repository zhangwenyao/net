...
ifdef DEBUG
	...
	export CXXFLAGS	= ${USER_DEFINES} -Wall -O0 -I$(DIR_INC) -g ${OPENMP} -DDEBUG -std=c++11
	export LDFLAGS	= -Wall -O0 -g -DDEBUG ${OPENMP}
else
	export CFLAGS	= ${USER_DEFINES} -Wall -O3 -I$(DIR_INC) ${OPENMP}
	export CXXFLAGS	= ${USER_DEFINES} -Wall -O3 -I$(DIR_INC) ${OPENMP} -std=c++11
	export LDFLAGS	= -Wall -O3 ${OPENMP}
endif
