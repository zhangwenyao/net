...
namespace common
{
    ...
    int read0map(std::istream &is, std::map<T1, T2> &m);
    template <typename T1, typename T2>
    int read0map(const char *name, std::map<T1, T2> &m);
    template <typename T1, typename T2>
    int read0set(std::istream &is, std::vector<std::set<T2>> &s, const std::map<T1, T2> &u, const std::map<T1, T2> &v);
    template <typename T1, typename T2>
    int read0set(const char *name, std::vector<std::set<T2>> &s, const std::map<T1, T2> &u, const std::map<T1, T2> &v);
