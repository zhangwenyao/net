...
//**//****************************************************//*
int save_moduStk(std::ostream& os, const VNodeType& moduStk, const VRNodeType& moduRange);
...
int moduStk_sort(VNodeType& moduStk, VRNodeType& moduRange, VNodeType& moduNum);    //各组按节点编号排序

int cal_modularity(VNodeType& moduVal, VNodeType& moduStk, VNodeType& moduNum, VRNodeType& moduRange, const VVNodeType &p2p, const VVNodeType& p2pIn, const int dirFlag = 0);   // 分组
...
int cal_moduLKK(VVLinkType& moduLKK, const NodeType moduSize, const VNodeType& moduVal, const VVNodeType& p2p); // 统计不同组之间连边数
int cal_moduCoef(double& moduCoef, const VVLinkType& moduLKK, const LinkType& linkSize);  // 计算分组系数
