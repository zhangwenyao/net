...
// ******************************************************
int network::betweenness::cal_betweenness0(VDouble& betwNode, VVDouble& betwEdge, double& meanNode,
...
// ******************************************************
int network::betweenness::cal_betweenness(VDouble& betwNode, VVDouble& betwEdge, double& meanNode,
    double& meanEdge, VVDistType& minDistMatr, VDouble& minDistMean,
