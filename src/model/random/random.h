#ifndef MODEL__RANDOM__RANDOM_H_
#define MODEL__RANDOM__RANDOM_H_
...
namespace random {
  ...
  int addLink_linkMatrC_ranNode2(VVChar& linkMatrC, const VNodeType& nodeDeg,
      VNodeType& p2pSize, VNodeType& remNodeNum, LinkType& linkRemain,
      const LinkType tryCount); // 每次直接随机抽取两个点连边
  int addLink_linkMatr_ranNode2(VVDistType& linkMatr,
  ...
  int addLink_p2p_ranNode(VVNodeType& p2p, const VNodeType& nodeDeg,
      VNodeType& remNodeNum, LinkType& linkRemain, const LinkType tryCount);
