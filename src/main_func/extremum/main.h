...
namespace extremum {
  ...
  constexpr double kGamma = 3.5;
  const std::string kGammaString = "3.5";
#else
  ...
  const std::string alpha_strings[] = { "C1", "C2", "2", "3d2", "1", "3d4",
    "1d2", "1d4", "-1d2", "-1", "-2" };
#elif defined(MAIN_EXTREMUM_ALPHAS20)
...
#else // defined(MAIN_EXTREMUM_ALPHAS16)
