...
int degArr_2_linkSize(LinkType& linkSize, const VNodeType& degArrVal, const VNodeType& degArrSize, const int dirFlag = 0);
int degArr_2_linkSum(VLinkType& linkSum, const VNodeType& degArrVal, const VNodeType& degArrSize);
int nodeDeg_2_linkSize(LinkType &linkSize, const VNodeType& nodeDeg, const int dirFlag = 0);
...
int addLink_linkMatrC_ranNode2(VVChar& linkMatrC, VNodeType& nodeDeg, VNodeType& p2pSize, VNodeType& remPoiNum, LinkType& linkRemain, const LinkType tryCount = 10);	// 每次直接随机抽取两个点连边
int addLink_linkMatr_ranNode2(VVDistType& linkMatr, VNodeType& nodeDeg, VNodeType& p2pSize, VNodeType& remPoiNum, LinkType& linkRemain, const LinkType tryCount = 10);	// 每次直接随机抽取两个点连边

int addLink_p2p_ranNode(VVNodeType& p2p, VNodeType& nodeDeg, VNodeType& remPoiNum, LinkType &linkRemain, const LinkType tryCount);	// 每次直接随机抽取两个点连边
int addLink_p2p_ranNode0(VVNodeType& p2p, VNodeType& link, VNodeType& nodeDeg, VNodeType& remPoiNum, LinkType &linkRemain, const LinkType tryCount);	// 每次直接随机抽取两个点连边
...
int addLink_p2p_proDeg(VVNodeType& p2p, VNodeType& link, const VNodeType& nodeDeg, const NodeType kMax, VNodeType& remPoiNum, LinkType &linkRemain, const LinkType tryCount);	// 随机选节点，概率正比于节点度

int addLink_p2p_ranLink(VVNodeType& p2p, VNodeType& nodeDeg, LinkType &linkRemain, VNodeType& link, const LinkType tryCount);	// 所有度中随机选
int addLink_p2p_ranLink_lkkProb(VVNodeType& p2p, const VNodeType& nodeDeg, VVDouble& lkkProb, MNodeType& degArrNo, NodeType &remPoiSize, LinkType &linkRemain, VNodeType& link, const LinkType tryCount);	// 剩余度中随机选点，且概率正比于lkkProb

int delLink_p2p_ranLink(VVNodeType& p2p, VNodeType& nodeDeg, VNodeType& remPoiNum, LinkType &linkRemain, const LinkType linkSize, VNodeType& link, LinkType delCount);	// 随机选边
int delLink_linkMatrC_randNode10(VVChar& linkMatrC, const NodeType nodeSize, VNodeType& nodeDeg, VNodeType& p2pSize, VNodeType& remPoiNum, LinkType &linkRemain, const LinkType linkSize, LinkType delCount);	// 随机选点删边
int delLink_p2p_randNode(VVNodeType& p2p, const NodeType nodeSize, const VNodeType& nodeDeg, VNodeType& remPoiNum, NodeType &remPoiSize, LinkType &linkRemain, const LinkType linkSize, LinkType delCount);	// 随机选点删边
...
int read_weight_link(VVWeightType& vvweight, VVWeightType& vvweightIn, const LinkType linkSize, const char *name, const unsigned weight_m = 2, const unsigned weight_n = 3, const int dirFlag = 0);
int read_link_weight_0(VNodeType& link, LinkType& linkSize, VVWeightType& vvweight, VVWeightType& vvweightIn, const char *name, const unsigned weight_m = 2, const unsigned weight_n = 3, const int dirFlag = 0);
