...
int network::modularity::save_moduStk(const VNodeType& moduStk, const VRNodeType& moduRange,
...
// ******************************************************
int network::modularity::modularity_move(const NodeType a, const NodeType b, VNodeType& moduStk,
                    VNodeType& moduNum,
...
int network::modularity::modularity_merge(const NodeType a, const NodeType b, VNodeType& moduVal,
...
int network::modularity::moduStk_sort(VNodeType& moduStk, VRNodeType& moduRange,
                 VNodeType& moduNum) {
...
// ******************************************************
int network::modularity::cal_modularity(VNodeType& moduVal, VNodeType& moduStk, VNodeType& moduNum,
...
int network::modularity::update_modularity_iNode(const NodeType i, VNodeType& moduVal,
                            VNodeType& moduStk, VNodeType& moduNum,
                            VRNodeType& moduRange, const VVNodeType& p2p,
                            const VVNodeType& p2pIn, const int dirFlag) {
...
// ******************************************************
int network::modularity::cal_moduLKK(VVLinkType& moduLKK, const NodeType moduSize,
...
int network::modularity::cal_moduCoef(double& moduCoef, const VVLinkType& moduLKK,
                 const int dirFlag) {
...
int network::modularity::cal_moduNodeCoef(VDouble& moduNodeCoef, const NodeType moduSize,
                     const VNodeType& moduVal, const VVNodeType& p2p) {
  const NodeType nodeSize = p2p.size();
  VNodeType s;
  moduNodeCoef.clear();
