...
{
    if(!net.dirFlag){
        if(!net.lkk.empty() && !net.weightFlag) cal_pearson_lkk(net.params_pearson.pearson, net.lkk, net.degArrVal, net.linkSize);
        if(!net.p2p.empty()){
            ...
            if(!net.weightFlag){
                if(net.lkk.empty()) cal_pearson(net.params_pearson.pearson, net.p2p, net.linkSize);
            }else cal_pearson_dir_weight(net.params_pearson.pearson, net.params_pearson.rho, net.p2p, net.vvweight, net.netWeight, net.nodeDeg, net.nodeDeg, net.weightFlag);
        }
        ...
        cal_neiAveDeg_weight(net.neiAveDeg, net.nodeNeiAveDeg, net.nodeDeg, net.degArrSize, net.degArrNo, net.degArrVal, net.degArrWeight, net.nodeWeight, net.weightFlag);
        cal_pearson_dir_weight(net.params_pearson.pearson, net.params_pearson.rho, net.p2p, net.vvweight, (net.weightFlag ? net.netWeightOut : net.linkSize), net.nodeDeg, net.nodeDeg, net.weightFlag);
        ...
        cal_pearson_dir_weight(net.params_pearson.OutIn, net.params_pearson.rhoOutIn, net.p2p, net.vvweight, (net.weightFlag ? net.netWeightOut : net.linkSize), net.nodeDegOut, net.nodeDegIn, net.weightFlag);
        ...
        if(STAT_TYPE_DIRAA){
            ...
            cal_pearson_dir_weight(net.params_pearson.OutOut, net.params_pearson.rhoOutOut, net.p2p, net.vvweight, (net.weightFlag ? net.netWeightOut : net.linkSize), net.nodeDegOut, net.nodeDegOut, net.weightFlag);
            ...
            cal_pearson_dir_weight(net.params_pearson.InIn, net.params_pearson.rhoInIn, net.p2p, net.vvweight, (net.weightFlag ? net.netWeightOut : net.linkSize), net.nodeDegIn, net.nodeDegIn, net.weightFlag);
            ...
            cal_pearson_dir_weight(net.params_pearson.InOut, net.params_pearson.rhoInOut, net.p2p, net.vvweight, (net.weightFlag ? net.netWeightOut : net.linkSize), net.nodeDegIn, net.nodeDegOut, net.weightFlag);
        }
    }
