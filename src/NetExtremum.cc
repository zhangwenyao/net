...
// *******************************************************************
int net_extremum::lkk_new_p2p(VVNodeType& p2p, const VVLinkType& lkk,
...
// *******************************************************************
int net_extremum::lkk_extreme_pearson(VVLinkType& lkk,
...
// *******************************************************************
int net_extremum::cal_Min_lkk_side2mid(VVLinkType& lkk,
...
int net_extremum::cal_Min_lkk_side2mid_fix(VVLinkType& lkk,
    const VNodeType& degArrVal, const VNodeType& degArrSize,
...
int net_extremum::cal_Min_lkk_mid2side(
...
int net_extremum::cal_Min_lkk3_mid2side(VLkk3LinkType& lkk3,
    const VNodeType& degArrVal, const VNodeType& degArrSize)
{
  const NodeType degSize = degArrVal.size();
  lkk3.clear();
...
// *******************************************************************
int net_extremum::cal_Max_lkk(VVLinkType& lkk, const VNodeType& degArrVal,
...
int net_extremum::Max_new(VVNodeType& p2p, const VNodeType& nodeDeg,
    const VNodeType& degArrVal, const VNodeType& degArrSize,
    const VNodeType& degArrSum)
{
  if (degArrSize.empty()) {
...
// *******************************************************************
int net_extremum::Min_new(VVNodeType& p2p, const VNodeType& nodeDeg,
    const VNodeType& degArrVal, const VNodeType& degArrSize,
    const VNodeType& degArrSum)
{
  if (degArrSize.empty()) {
...
int net_extremum::Min_new_lkk_p2p(VVNodeType& p2p, VVLinkType& lkk,
...
int net_extremum::Min_new_lkk3(VLkk3LinkType& lkk3,
    const VNodeType& degArrVal, const VNodeType& degArrSize)
{
  if (degArrSize.empty()) {
    ERROR();
