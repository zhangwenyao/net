#ifndef STATISTICS__MODULARITY__MODULARITY_H_
#define STATISTICS__MODULARITY__MODULARITY_H_
...
namespace modularity {
  ...
  int cal_modularity(VNodeType& moduVal, VNodeType& moduStk,
      VNodeType& moduNum, VRNodeType& moduRange, const VVNodeType& p2p,
