...
int common_save2(std::ostream &os, T *(&a)[n], T2 (&size)[n],
                 const char c = '\t');
template <typename T, typename T2, const size_t n>
int common_save2(const char *name, T *(&a)[n], T2 (&size)[n],
                 const char c = '\t');
template <typename T, typename T2, const size_t n>
...
template <typename T>
int common_save1(std::ostream &os, const std::vector<T> &v,
                 const char c = '\t');
template <typename T>
int common_save1(const char *name, const std::vector<T> &v,
                 const char c = '\t');
template <typename T>
