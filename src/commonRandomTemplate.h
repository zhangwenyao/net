...
//**//********************************************************//*
    template <typename T>
int random_new_randKArr (T *a, const size_t n, const double *p, const size_t size)
{
    ...
    template <typename T>
int random_new_randKArr2 (T *a, const size_t n, const double *p, const size_t size)
{
    typedef struct{
        double val;
        size_t left, right;
    ...
    template <typename T>
int random_new_randKArr (T *a, const size_t n, const double *p, const T *val, const size_t size)
{
    for (size_t i = 0, k; i < n; i++) {
        do {
            k = RAND2() % size;
    ...
    template <typename T>
int random_new_rankKArr (T *a, const size_t n, const double *p, const size_t size)
{
    T t;
    for (size_t i = 0, k; i < n; i++) {
        do {
