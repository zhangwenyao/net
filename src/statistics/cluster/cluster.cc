...
// ******************************************************
int network::cluster::cal_cluster_directed_weight(double &cluster_c, VDouble &cluster,
...
int network::cluster::cal_cluster_directed_unweight(double &cluster_c, VDouble &cluster,
                                  const VVDistType &linkMatr) {
  const NodeType nodeSize = linkMatr.size();
  VVNodeType p2p(nodeSize);
  VNodeType K(nodeSize, 0);   // nodeDeg = Out + In
