...
int rewire_rho(LinkType L, const double rho, VVNodeType& p2p, VNodeType& link);
int rewire_rho_dir(LinkType L, const double rho, VVNodeType& p2p,
                   VNodeType& link);
int change_p2p_link(VVNodeType& p2p, const NodeType i1, const NodeType i2,
                    const NodeType j2);
