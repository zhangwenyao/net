      ...
      for (NodeType tj1 = 0; tj1 < degSize2; tj1++) {
        ...
        for (NodeType ti2 = 0; ti2 < degSize; ti2++) {
          for (NodeType tj2 = 0; tj2 < degSize2; tj2++) {
            ...
            if (n2 <= 0) continue;
            if ((ti2 < ti1 && tj2 < tj1) || (ti2 > ti1 && tj2 > tj1))
              ls += n1 * n2;
            if ((ti2 < ti1 && tj2 > tj1) || (ti2 > ti1 && tj2 < tj1))
              ld += n1 * n2;
          }
      ...
      for (NodeType tj1 = 0; tj1 <= ti1; tj1++) {
        ...
        for (NodeType ti2 = 0; ti2 < degSize; ti2++) {
          for (NodeType tj2 = 0; tj2 <= ti2; tj2++) {
            ...
            if ((ti2 < ti1 && tj2 > tj1) || (ti2 > ti1 && tj2 < tj1))
              ld += n1 * n2;
            if ((ti2 < tj1 && tj2 < ti1) || (ti2 > tj1 && tj2 > ti1))
              ls += n1 * n2;
            if ((ti2 < tj1 && tj2 > ti1) || (ti2 > tj1 && tj2 < ti1))
              ld += n1 * n2;
          }
  ...
  if (dir) {
    ...
    for (NodeType ti1 = 0; ti1 < degSize; ti1++) {
      for (NodeType tj1 = 0; tj1 < degSize2; tj1++) {
        ...
        // ti2 > ti1 && tj2 > tj1
        if (ti1 < degEnd && tj1 < degEnd2)
          ls += n1 * (linkSize - lkkSum[ti1][degEnd] + lkkSum[ti1][tj1] -
                      lkkSum[degEnd2][tj1]);
        // ti2 < ti1 && tj2 > tj1
        if (ti1 > 0 && tj1 < degEnd2)
          ld += n1 * (lkkSum[ti1 - 1][degEnd2] - lkkSum[ti1 - 1][tj1]);
        // ti2 > ti1 && tj2 < tj1
        if (ti1 < degEnd && tj1 > 0)
          ld += n1 * (lkkSum[degEnd][tj1 - 1] - lkkSum[ti1][tj1 - 1]);
      }
    }
    tau = ((double)ls - ld) / linkSize / (linkSize - 1);
  } else {  // !dir
    for (NodeType ti1 = 0; ti1 < degSize; ti1++) {
      for (NodeType tj1 = 0; tj1 <= ti1; tj1++) {
        ...
        // ti1->tj1 : ti2->tj2
        if (tj1 > 0)
          ls += n1 * lkkSum[ti1 - 1][tj1 - 1];  // ti2 < ti1 && tj2 < tj1
        if (ti1 < degEnd)
          ls += n1 * (linkSize - lkkSum[ti1][ti1] + lkkSum[ti1][tj1] -
                      lkkSum[degEnd][tj1]);  // ti2 > ti1 && tj2 > tj1
        if (ti1 > tj1 + 1)
          ld += n1 * (lkkSum[ti1 - 1][ti1 - 1] -
                      lkkSum[ti1 - 1][tj1]);  // ti2 < ti1 && tj2 > tj1    <==>
                                              // tj1 < tj2 <= ti2 < ti1
        if (ti1 < degEnd && tj1 > 0)
          ld += n1 * (lkkSum[degEnd][tj1 - 1] -
                      lkkSum[ti1][tj1 - 1]);  // ti2 > ti1 && tj2 < tj1    <==>
                                              // tj2 < tj1 <= ti1 < ti2
        // ti1->tj1 : tj2->ti2
        if (tj1 > 0)
          ls += n1 * lkkSum[tj1 - 1][tj1 - 1];  // tj2 < ti1 && ti2 < tj1
                                                // <==>    tj2 <= ti2 < tj1 <=
                                                // ti1
        if (ti1 < degEnd)
          ls += n1 * (linkSize - lkkSum[degEnd][ti1]);  // tj2 > ti1 && ti2 >
                                                        // tj1    <==>    ti2 >=
                                                        // tj2 > ti1 >= tj1
        if (ti1 > 0 && tj1 < degEnd)
          ld += n1 * (lkkSum[degEnd][ti1 - 1] -
                      lkkSum[tj1][tj1 < ti1 - 1 ? tj1 : ti1 - 1]);  // tj2 < ti1
                                                                    // && ti2 >
                                                                    // tj1
        // ld += 0; // tj2 > ti1 && ti2 < tj1    <==>    ti2 >= tj2 > ti1 >= tj1
        // > ti2    <==>    NULL
